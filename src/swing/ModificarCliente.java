	...
	private void initGUI() {
		try {
			...
			getContentPane().setLayout(null);
			{
				...
				titulo.setText("MODIFICACIÓN CLIENTE");
			...
			}
			{
				...
				alta.setBounds(119, 363, 113, 28);
				alta.setVisible(false);
				alta.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent evt) 
					{
						int rdo = sistemaCocheras.modificarCliente(dni.getText(), nombre.getText(), domicilio.getText(), mail.getText(), telefono.getText(), 1);
						String mensaje = "";
						switch(rdo) {
							case ExitCodes.OK: {
